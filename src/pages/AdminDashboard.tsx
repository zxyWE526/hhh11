        ...
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto bg-white text-gray-900">
          ...
          {editingProduct && (
            <div className="space-y-4 mt-4">
              ...
              <div>
                <Label className="text-sm font-medium text-gray-700">图片 URL</Label>
                <Input value={editingProduct.image} onChange={e => setEditingProduct({ ...editingProduct, image: e.target.value })} className="bg-white text-gray-900 border-gray-300" />
              </div>
      ...
      <Dialog open={showAddProduct} onOpenChange={setShowAddProduct}>
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto bg-white text-gray-900">
          ...
          <div className="space-y-4 mt-4">
            ...
            <div>
              <Label className="text-sm font-medium text-gray-700">图片 URL</Label>
              <Input value={newProduct.image} onChange={e => setNewProduct({ ...newProduct, image: e.target.value })} placeholder="https://picsum.photos/..." className="bg-white text-gray-900 border-gray-300" />
            </div>
            <div>
              <Label className="text-sm font-medium text-gray-700">描述</Label>
